...
public class Event implements CsvConvertible
{
    ...
    public String toCsv()
    {
        return String.format("\"%s\"\"%s\";\"%s\";\"%s\";\"%s\";\"%d\"", owner.getEmail(), name, location, date, startTime, durationMinutes);
    }

    @Override
    public String getCsvHeader()
    {
        return "\"Owner Email\";\"Name\";\"Location\";\"Date\";\"Start Time\";\"Duration (minutes)\"";
    }
}